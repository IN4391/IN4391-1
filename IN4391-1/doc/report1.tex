...
Although the results where not what we had hoped it would be, we still got a good understanding of the complications that are around when designing and implementing a distributed system.
